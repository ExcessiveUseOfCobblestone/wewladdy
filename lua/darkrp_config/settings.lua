...
GM.Config.mprintamount                  = math.random(100,300)
...
GM.Config.printeroverheatchance         = 25
-- printerreward - Reward for destroying a money printer.
GM.Config.printerreward                 = 975
